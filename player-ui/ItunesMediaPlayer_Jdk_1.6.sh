...
#JAVACMD="$progdir/../PlugIns/1.6.0.jdk/Contents/Home/bin/java"
JAVACMD="/System/Library/Java/JavaVirtualMachines/1.6.0.jdk/Contents/Home/bin/java"
...
exec "$JAVACMD" -Duser.dir=$progdir -classpath "$progdir/../Java/ItunesMediaPlayer-jar-with-dependencies.jar" \
      com.gps.itunes.media.player.ui.Main \
